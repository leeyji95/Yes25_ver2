                ...
                <div class="col-xl-3 col-sm-6 py-2">
                    <div class="card bg-success text-white h-100">
                        <div class="card-body bg-success">
                            ...
                            <h6 class="text-uppercase">월 매출현황</h6>
                            <h1 class="display-4">644,000원(천)</h1>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 py-2">
                    <div class="card text-white bg-danger h-100">
                        <div class="card-body bg-danger">
                            ...
                            <h6 class="text-uppercase">도서물류현황</h6>
                            <h1 class="display-4">7000권</h1>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 py-2">
                    <div class="card text-white bg-info h-100">
                        <div class="card-body bg-info">
                            ...
                            <h6 class="text-uppercase">발주현황</h6>
                            <h1 class="display-4">125권</h1>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-sm-6 py-2">
                    <div class="card text-white bg-warning h-100">
                        <div class="card-body">
                            ...
                            <h6 class="text-uppercase">직원수</h6>
                            <h1 class="display-4">368명</h1>
                        </div>
                    </div>
                </div>
            </div>
