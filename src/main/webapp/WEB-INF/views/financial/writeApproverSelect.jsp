...
<script type="text/javascript">
	...
	function sendTxt(){
		window.opener.document.frmWrite.writeApproverInputNumber.value = document.frmMember.usernameSelect.value;
		window.opener.document.frmWrite.writeApproverInputText.value = document.frmMember.nameSelect.value;
		self.close();
	}
</script>
