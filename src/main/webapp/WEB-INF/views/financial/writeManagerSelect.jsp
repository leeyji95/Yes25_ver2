...
<script type="text/javascript">
	...
	function sendTxt(){
		window.opener.document.frmWrite.writeManagerInputNumber.value = document.frmMember.usernameSelect.value;
		window.opener.document.frmWrite.writeManagerInputText.value = document.frmMember.nameSelect.value;
		self.close();
	}
</script>
