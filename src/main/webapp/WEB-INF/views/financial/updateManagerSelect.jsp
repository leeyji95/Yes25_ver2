...
<h1 class="display-4 d-none d-sm-block" 
	style="text-align: center;">담당자를 선택해주세요.</h1>
<c:choose>
...
<script type="text/javascript">
	...
	function sendTxt(){
		window.opener.document.frmUpdate.updateManagerInputNumber.value = document.frmMember.usernameSelect.value;
		window.opener.document.frmUpdate.updateManagerInputText.value = document.frmMember.nameSelect.value;
		self.close();
	}
</script>
