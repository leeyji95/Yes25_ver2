		...
		<div class="content">
			...
			<section class="content-inner">
				<div class="col main pt-5 mt-3">
					<div class="div_title">
						<h1 class="display-4 d-none d-sm-block" id="title">발주요청</h1>
					</div>
					<hr>
								...
								<div class="col-sm-6">
									<ul class="nav nav-tabs" style="display: flex;">
										<li class="nav-item"><a class="nav-link active"
											data-toggle="tab" href="#search-result-tab">검색결과</a></li>
										<li class="nav-item"><a class="nav-link"
											data-toggle="tab" href="#order-paper-tab">발주서</a></li>
									</ul>
											...
											<form role="form" id="add-order">
												...
												<div class="form-group">
													...
													<div class="input-group">
														<input type="text" class="form-control enable-search"
															name="pub_name" id="add-order-pub-name"
															placeholder="거래처명"> <span
												...
												<div class="form-group">
													...
													<div class="input-group">
														<input type="text" class="form-control enable-search"
															name="book_subject" id="add-order-book-subject"
															placeholder="도서명"> <span
															class="input-group-append">
															<button type="button" class="btn btn-danger"
																id="clear-book-subject">
																<i class="fa fa-times"></i>
															</button>
														</span>
													</div>
												...
												<div class="form-group">
													<label for="add-order-order-unit-cost">단가</label> <input
														type="number" class="form-control" name="ord_unit_cost"
														id="add-order-order-unit-cost" placeholder="단가">
												</div>
												<div class="form-group">
													<label for="add-order-order-quantity">수량</label> <input
														type="number" class="form-control" name="ord_quantity"
														id="add-order-order-quantity" placeholder="수량">
												</div>
