...
<link rel="stylesheet" href="${pageContext.request.contextPath}/CSS/purchase/vendor.css" />
								...
								<div class="col-sm-6">
									<ul class="nav nav-tabs" style="display: flex;">
										<li class="nav-item"><a class="nav-link active"
											data-toggle="tab" href="#pub-reg-tab">거래처 등록</a></li>
										<li class="nav-item"><a class="nav-link"
											data-toggle="tab" href="#pub-search-tab">거래처 검색</a></li>
									</ul>
												...
												<div class="card-body">
													<form role="form" id="reg-pub" method="POST">
														<div class="form-group">
															<label for="reg-pub-pub-name">거래처명</label> <input
																type="text" class="form-control" id="reg-pub-pub-name"
																name="pub_name" placeholder="거래처명" required>
														</div>
														<div class="form-group">
															<label for="reg-pub-pub-num">사업자 등록번호</label> <input
																type="text" class="form-control" id="reg-pub-pub-num"
																name="pub_num" placeholder="사업자 등록번호" required>
														</div>
														<div class="form-group">
															<label for="reg-pub-pub-rep">대표자명</label> <input
																type="text" class="form-control" id="reg-pub-pub-rep"
																name="pub_rep" placeholder="대표자명" required>
														</div>
														<div class="form-group">
															<label for="reg-pub-pub-contact">연락처</label> <input
																type="text" class="form-control"
																id="reg-pub-pub-contact" name="pub_contact"
																placeholder="연락처" required>
														</div>
														<div class="form-group">
															<label for="reg-pub-pub-address">주소</label> <input
																type="text" class="form-control"
																id="reg-pub-pub-address" name="pub_address"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<table class="table table-boardered">
						<tr>
							<th>거래처명</th>
							<td><input type="text" class="form-control" name="pub_name"
								placeholder="거래처명" required></td>
						</tr>
						<tr>
							<th>사업자 등록번호</th>
							<td><input type="text" class="form-control" name="pub_num"
								placeholder="사업자 등록번호" required></td>
						</tr>
						<tr>
							<th>대표자명</th>
							<td><input type="text" class="form-control" name="pub_rep"
								placeholder="대표자명"></td>
						</tr>
						<tr>
							<th>연락처</th>
							<td><input type="text" class="form-control"
								name="pub_contact" placeholder="연락처"></td>
						</tr>
						<tr>
							<th>주소</th>
							<td><input type="text" class="form-control"
								name="pub_address" placeholder="주소"></td>
						</tr>
					</table>
				</div>
